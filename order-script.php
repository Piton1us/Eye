...
$mail->msgHTML('Билет на ' . $film['title'] . "<br>" . "<br>" ."Дата ". $date . "Время " . $time . "<br>" . "<br>" . "Ряд " . $row . " Место " . $seat . "<br>" . "<br>". "Итого " . $price); //$mail->msgHTML(file_get_contents('contents.html'), __DIR__); //Read an HTML message body from an external file, convert referenced images to embedded,
